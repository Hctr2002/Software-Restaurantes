...
```text
# Contexto
Eres un desarrollador técnico trabajando en el proyecto "Menu Bites" bajo la arquitectura y estándares del ecosistema. Has completado un avance en tu desarrollo y necesitas estructurar tu reporte.
