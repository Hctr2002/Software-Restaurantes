  ...
  return (
    <div className="p-5 bg-foreground/5 rounded-2xl border border-foreground/5 space-y-3">
      ...
      <div className="flex items-center space-x-4">
        ...
        <span className="text-foreground font-black text-lg w-16 text-right">{value} min</span>
      </div>
    </div>
  );
}
...
export function ThresholdsTab({ draft, onChange }: Props) {
  ...
  return (
    <div className="space-y-5">
      <p className="text-foreground/40 text-sm">Minutos a partir de los cuales un pedido de barra cambia de color por demora.</p>
      ...
      <div className="p-4 bg-foreground/5 rounded-2xl border border-foreground/5">
        <p className="text-[11px] text-foreground/40 uppercase tracking-widest font-bold mb-3">Vista previa</p>
