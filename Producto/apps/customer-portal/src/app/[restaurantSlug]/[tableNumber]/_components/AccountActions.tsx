            ...
            >
              {tableOrdersCount > 0 && (
                <button 
                  ...
                  className="glass-premium bg-card/90 flex items-center gap-1.5 sm:gap-2 px-3 sm:px-5 py-2 sm:py-3 rounded-xl sm:rounded-2xl shadow-xl font-bold text-[10px] sm:text-xs uppercase tracking-wider text-foreground border border-white/10 hover:bg-card transition-all active:scale-95"
                >
              ...
              <button 
                ...
                className={`glass-premium bg-card/90 flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-5 py-2 sm:py-3 rounded-xl sm:rounded-2xl shadow-xl font-bold text-[10px] sm:text-xs uppercase tracking-wider transition-all active:scale-95 border border-white/10 ${
              ...
              <button 
                ...
                className="glass-premium bg-card/90 flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-5 py-2 sm:py-3 rounded-xl sm:rounded-2xl shadow-xl font-bold text-[10px] sm:text-xs uppercase tracking-wider text-primary border border-primary/20 hover:bg-primary/10 transition-all active:scale-95"
              >
