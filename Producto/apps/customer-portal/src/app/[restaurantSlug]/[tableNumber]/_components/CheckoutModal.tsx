...
/**
 * CheckoutModal — Hoja deslizable de confirmación de pedido.
 * Lista los ítems del carrito, muestra la mesa asignada y permite confirmar o cancelar.
 * En caso de error al colocar el pedido, muestra el mensaje recibido del servidor.
 */
...
/**
 * Resumen y confirmación del pedido antes de enviarlo a cocina/bar.
  ...
  return (
    <div className="fixed inset-0 z-[60] animate-in fade-in duration-300">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-card rounded-t-[2.5rem] p-8 max-h-[90vh] overflow-y-auto animate-in slide-in-from-bottom duration-500 border-t border-foreground/10 shadow-[0_-20px_50px_rgba(0,0,0,0.3)]">
        ...
        {/* Mesa asignada — se muestra si table.data fue resuelto correctamente */}
        {table.data ? (
          ...
          /* Sin mesa detectada — el cliente debe escanear el QR de su mesa */
        ...
        {/* Error devuelto por el servidor al colocar el pedido */}
        {table.orderError && (
