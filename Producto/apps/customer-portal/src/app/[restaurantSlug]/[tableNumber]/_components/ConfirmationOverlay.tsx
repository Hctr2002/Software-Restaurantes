...
/**
 * ConfirmationOverlay — Pantalla de éxito a pantalla completa tras confirmar un pedido.
 * Se muestra sobre todo el contenido (z-index 100) y desaparece al presionar "Volver al Menú".
 */
...
/**
 * Pantalla de confirmación animada tras realizar un pedido con éxito.
 * Solo se renderiza cuando `show` es true; el resto del tiempo retorna null.
 */
export function ConfirmationOverlay({ show, tableData, restaurantName, onClose }: ConfirmationOverlayProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Icono con efecto ping — indica éxito visual */}
