  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-sm sm:text-base text-foreground/60 font-bold mb-2 tracking-tight leading-relaxed">
        ...
        <button 
          onClick={onClose} 
          className="w-full py-4 sm:py-5 bg-foreground/5 border border-foreground/10 rounded-2xl sm:rounded-3xl text-xs sm:text-sm font-black uppercase tracking-[0.2em] text-foreground hover:bg-foreground/10 transition-all active:scale-95"
        >
          Volver al Menú
        </button>
      </motion.div>
