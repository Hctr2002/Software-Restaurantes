    ...
    return (
      ...
      >
        <View style={styles.notifCardContainer}>
          ...
          >
            ...
            <View style={styles.notifContent}>
              <View style={styles.notifHeader}>
                <Text style={styles.notifTitle}>Mesa {item.tables?.number || 'S/N'}</Text>
                <Text style={styles.notifTime}>{timeAgo(item.createdAt)}</Text>
              </View>
              <Text style={styles.notifSub}>Total: {formatCurrency(total)}</Text>
          ...
          >
            <CheckCircle2 size={24} color={MB_COLORS.brandAccent} />
          </TouchableOpacity>
        </View>
      </Animated.View>
    );
      ...
      <View style={styles.header}>
        <View style={styles.headerInfo}>
          ...
          <View>
            ...
            <Text style={styles.subtitle}>{visibleNotifications.length} pendientes</Text>
          </View>
        </View>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyState}>
              <CheckCircle2 size={48} color={MB_COLORS.brandAccent} style={{ opacity: 0.3 }} />
