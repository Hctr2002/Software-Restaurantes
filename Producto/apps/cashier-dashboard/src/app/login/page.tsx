...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (role !== REQUIRED_ROLE) {
        ...
        setError(`Esta app es exclusiva para Cajeros. Tu rol es: ${role}`);
        return;
      }
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-4 overflow-hidden bg-slate-950">
      <div className="absolute inset-0 bg-gradient-to-br from-green-500/10 via-transparent to-background" />
      <main className="relative z-10 w-full max-w-md">
        <Card className="border-white/5 backdrop-blur-2xl">
          <CardHeader className="text-center space-y-2">
            ...
            <CardDescription>Dashboard de Caja</CardDescription>
          </CardHeader>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              <div className="space-y-4">
                <div className="relative">
                  ...
                  <Input
                    type="email"
                    placeholder="cajero@menubites.com"
                    required
                    className="pl-10"
                    value={email}
