...
export function CuentaSheet({ tableLabel, orders, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[70] animate-in fade-in duration-200">
      ...
      <div className="absolute bottom-0 left-0 right-0 glass-panel rounded-t-[2.5rem] p-6 max-h-[85vh] overflow-y-auto animate-in slide-in-from-bottom duration-300 border-t border-white/10 shadow-2xl">
